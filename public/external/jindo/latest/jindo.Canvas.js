...
jindo.Canvas = jindo.$Class({
	...
	/**
	 * canvas 엘리먼트의 너비를 구하거나 설정한다.
	 * @param {Number} n 파라메터를 지정하면 너비가 설정된다.
	 * @return {this || Number}
	 */
	width : function(n) {
		if (typeof n == "number") {
	...
	/**
	 * canvas 엘리먼트의 높이를 구하거나 설정한다.
	 * @param {Number} n 파라메터를 지정하면 높이가 설정된다.
	 * @return {this || Number}
	 */
	height : function(n) {
		if (typeof n == "number") {
	 ...
	 * @param {HashTable} htOption 컨텍스트에 지정할 옵션
...
drawFace([[0, 0], [1, 1]], { fillStyle : "rgb(255, 0, 0)" });
	 ...
	 * @return {this}
	 * @example
drawRect(20, 100, 100, 100, {fillStyle : "rgb(200, 200, 200)"}, true);
drawRect(20, 100, 100, 100, {strokeStyle:"rgb(10, 10, 10)", lineWidth:1}, false);
drawRect(20, 100, 100, 100, {fillStyle : "rgb(200, 200, 200)", strokeStyle:"rgb(10, 10, 10)", lineWidth:1}, true);
	 */
